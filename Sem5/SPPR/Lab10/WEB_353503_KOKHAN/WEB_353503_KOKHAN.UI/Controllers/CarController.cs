    ...
    public class CarController : Controller
    {
        ...
        public async Task<IActionResult> Index(string? category, int pageNo = 1)
        {
            ...
            if (Request.IsAjaxRequest())
            {
                ...
                ViewData["CurrentCategory"] = ViewBag.CurrentCategory;
                ViewData["CurrentPage"] = ViewBag.CurrentPage;
                ViewData["TotalPages"] = ViewBag.TotalPages;

                return PartialView("~/Views/Shared/Components/Car/_CarListPartial.cshtml", productResponse.Data);
            }
