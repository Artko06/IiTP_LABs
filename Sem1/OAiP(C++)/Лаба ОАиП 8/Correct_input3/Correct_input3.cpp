...
float correctInput_cost(float num, int i) {
	while (true) {
		if (!(std::cin >> num)) {
			std::cin.clear();
			while (std::cin.get() != '\n');
...
int correctInput_day(int num, int i) {
	while (true) {
		if (!(std::cin >> num)) {
			std::cin.clear();
			while (std::cin.get() != '\n');
...
int correctInput_month(int num, int i) {
	while (true) {
		if (!(std::cin >> num)) {
			std::cin.clear();
			while (std::cin.get() != '\n');
...
int correctInput_year(int num, int i) {
	while (true) {
		if (!(std::cin >> num)) {
			std::cin.clear();
			while (std::cin.get() != '\n');
...
int correctInput_num(int num, int i) {
	while (true) {
		if (!(std::cin >> num)) {
			std::cin.clear();
			while (std::cin.get() != '\n');
